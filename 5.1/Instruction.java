public class Instruction {
    ...
    public Instruction(OpCode opCode) { // Instruction con un solo attributo OpCode
        this.opCode = opCode;
    }

    public Instruction(OpCode opCode, int operand) { // Instruction con un attributo OpCode e uno int
        this.opCode = opCode;
    ...
    public String toJasmin () {
        ...
        switch (opCode) {
            ...
            case invokestatic : 
               if( operand == 1)  // se operand è 1 scriverà Output/print(I)V se è 0, o un altro numero, scriverà Output/read()I
